                ...
                <tr>
                  <td>
                    ...
                    <select id="txtfieldmodal">
                      <option value='a.kodesku'>SKU</option>
                      <option value='nmcust'>Customer</option>
                      <option value='nmseason'>Season</option>
                      <option value='a.kodeart'>Artikel</option>
                      <option value='a.nmmaterial'>Material</option>
                      <option value='a.nmwarna'>Warna</option>
                    </select>
                  </td>
                  <td>
                ...
                <!-- <tr>
                  <td> -->
                    ...
                    <!-- <div id="infoview" align="left"> -->
                      <INPUT id="txtperpagemodal" class="textbox" type="hidden" name="txtperpagemodal" value="15" onkeydown="enterfind(event)"/>
                    <!-- </div> -->
                 <!--  </td>
                  <td colspan="2">
