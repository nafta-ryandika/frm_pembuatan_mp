                ...
                <tr>
                  <td>
                    ...
                    <select id="txtfieldmodal">
                        <option value="dt1.hkdtiket">Kode Tiket</option>
                        <option value="dt1.hartikel">Art. Customer</option>
                        <option value="dt1.hartikel_kmbs">Art. Produksi</option>
                    </select>
                  </td>
                  <td>
