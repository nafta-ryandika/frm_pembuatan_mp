          ...
          <table id="myTableModal1" class="tablesorter">
            <thead>
              <tr>
                ...
                <th align="center">Kode Component</th>
                <th align="center">Nama Component</th>
                <th align="center">...</th>
              </tr>
            </thead>
            <tbody>
              <?php
              $sqlCOUNT = "SELECT subpkj, ket FROM kmmstsubpkj WHERE 1";
              $sqlCOUNT = $sqlCOUNT.$sqlWHERE;
              $result=mysql_query($sqlCOUNT);
              $count=mysql_num_rows($result);
              mysql_free_result($result);

              $sql="SELECT subpkj, ket FROM kmmstsubpkj WHERE 1";
              $sqlORDER = "ORDER BY subpkj, ket";
              ...
              if($count>0){
                ...
                while ($data = mysql_fetch_array($result, MYSQL_BOTH)){
                  ...
                  <tr onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'">
                    ...
                    <td align="left" nowrap><?php echo $data["ket"]; ?></td>
                    <td align="center" nowrap><?php echo "<button id='cmdselect' class='buttonadd' name='nmcmdselect' value='".$data['subpkj']."' onclick=\"select('".trim(htmlspecialchars($data["subpkj"]))."','".trim(htmlspecialchars($data["ket"]))."','".$inid."')\" >Select</button>"; ?></td>
                  </tr>
